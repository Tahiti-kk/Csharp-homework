...
namespace homework7
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Goods Goods1 = new Goods("iPod", 1999);
            Goods Goods2 = new Goods("iTouch", 3999);
            Goods Goods3 = new Goods("iPad", 5999);
            Goods Goods4 = new Goods("iPhone", 7999);

            OrderDetails goodsList1 = new OrderDetails(Goods1, 1);
            OrderDetails goodsList2 = new OrderDetails(Goods2, 2);
            OrderDetails goodsList3 = new OrderDetails(Goods3, 3);
            OrderDetails goodsList4 = new OrderDetails(Goods4, 4);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (newOrder != null && newOrder.Number != null && 
                newOrder.Phone != null)
            {
                bool idOK, phoneOK;
                idOK = false;
        ...
        private void ModButton_Click(object sender, EventArgs e)
        {
            ...
            if(newOrder != null)
            {
                newOrder.UpdateDetail();
                orderService.AddOrder(newOrder);
                orderService.DelOrder((Order)orderBindingSource1.Current);
